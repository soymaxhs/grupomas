<template>
    <b-container class="my-5">
        <b-form-row inline>
            <b-col>
                ...
                <b-form-input id="inline-form-input-url" class="mb-2 mr-sm-2 mb-sm-0"
                    placeholder="https://mi-direccion.com" v-model="inputUrl">
                </b-form-input>
            </b-col>
        ...
        <b-row v-if="data!=null" class="my-5">
            <b-col>
                <b-button @click="toDo" class="mr-10px">
                    Guardar Datos en BD
                </b-button>
                <b-button @click="downloadExcel" class="mr-10px">
                    Descargar Excel
                </b-button>
            </b-col>
        </b-row>
